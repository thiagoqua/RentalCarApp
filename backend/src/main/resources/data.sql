...
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
VALUES ('hatchback','hyundai','i30',2022,48.4,4,'manual','gasoline',TRUE,16,10,'https://www.hyundai.com/content/dam/hyundai/au/en/models/i30/2020/10/hatch/active/Hyundai_i30_Hatch_Front34_Active_PolarWhite_1000x667.png');
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
VALUES ('pickUp','ford','ranger',2021,69.0,4,'automatic','diesel',TRUE,18,14,'https://blogmedia.dealerfire.com/wp-content/uploads/sites/1027/2021/01/2021-Ford-Ranger-in-Iconic-Silver_o.png');
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
...
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
VALUES ('SUV','fiat','pulse',2023,66.1,4,'automatic','gasoline',TRUE,13,12,'https://legado.autoforce.com.br/assets/ddm/images/fiat-pulse/fiat_progetto.png');
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
...
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
VALUES ('offRoad','jeep','wrangler',2023,72.5,2,'manual','gasoline',TRUE,15,12,'https://medias.fcacanada.ca/jellies/renditions/2023/800x510/CC23_JLJL72_2TB_PGG_APA_XXX_XXX_XXX.1aaa5d21f651dcfd23d94bcacebe5ded.png');
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
VALUES ('luxury','rolls royce','ghost',2014,82.5,4,'automatic','gasoline',TRUE,19,14,'https://i.pinimg.com/originals/e1/04/86/e104867f8b2605040ad185c9c05e7c19.png');
INSERT INTO CAR (category,brand,model,born,price,doors,transmission,fueltype,AC,urban,route,image)
